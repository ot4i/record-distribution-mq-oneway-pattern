...
public class _jet_routeesql implements JET2Template {
    private static final String _jetns_c = "org.eclipse.jet.controlTags"; //$NON-NLS-1$

    public _jet_routeesql() {
        super();
    }
    ...
    public void generate(final JET2Context context, final JET2Writer __out) {
        ...
        out.write("/*******************************************************");  //$NON-NLS-1$        
        out.write(NL);         
        out.write("* Declare shared variables to record records sent to default");  //$NON-NLS-1$        
        out.write(NL);         
        out.write("********************************************************/");  //$NON-NLS-1$        
        out.write(NL);         
        out.write("DECLARE Defaults SHARED ROW;");  //$NON-NLS-1$        
        out.write(NL);         
        out.write("DECLARE Files SHARED INTEGER 0;");  //$NON-NLS-1$        
        out.write(NL);         
        out.write(NL);         
        out.write("\tCREATE COMPUTE MODULE RecordDefault");  //$NON-NLS-1$        
        out.write(NL);         
